...
class LlmManager:
    ...
    def init_models(self):
        api_key_web = ""
        base_url_web = 'https://api.openai.com/v1'

        base_url_loc = "http://127.0.0.1:11434/v1"
        api_key_loc = ""
        models_info = [
            ...
            ("codebooga",                base_url_loc,   api_key_loc,   False,    "19 GB",    2,    True,  "neural net",   ["Developer Code"],      "Coding Assistance",       "Advanced model for automated code generation and analysis."),
            ...
            ("dolphincoder",             base_url_loc,   api_key_loc,   False,    "4.2 GB",   1,    False, "transformer",  ["Programming Forums"],  "Coding",                  "Designed to interpret and answer programming queries."),
            ...
            ("llama3",                   base_url_loc,   api_key_loc,   False,    "4.7 GB",   1,    False, "llama",        ["Large Texts"],         "NLP",                     "Enhanced capabilities for understanding and generating natural language."),
            ...
            ("mistral-openorca",         base_url_loc,   api_key_loc,   False,    "4.1 GB",   1,    False, "transformer",  ["Open Data"],           "Open Tasks",              "Capable of handling diverse datasets for open-ended tasks."),
            ...
            ("moondream",                base_url_loc,   api_key_loc,   False,    "1.7 GB",   1,    False, "transformer",  ["Dream Analysis"],      "Dream Modeling",          "Specialized in modeling and interpreting dream content."),
            ...
            ("nexusraven",               base_url_loc,   api_key_loc,   False,    "7.4 GB",   2,    True,  "transformer",  ["Complex NLP Tasks"],   "Advanced NLP",            "Advanced NLP model for complex language understanding and generation."),
            ...
            ("notux",                    base_url_loc,   api_key_loc,   False,    "26 GB",    2,    True,  "transformer",  ["High-Capacity Tasks"], "Advanced Computation",    "Designed for computational tasks requiring extensive resources."),
            ...
            ("phi3",                     base_url_loc,   api_key_loc,   False,    "2.3 GB",   1,    False, "transformer",  ["Educational Content"], "Education",               "Designed to support and enhance educational applications."),
            ...
            ("solar",                    base_url_loc,   api_key_loc,   False,    "6.1 GB",   1,    False, "transformer",  ["Solar Data"],          "Energy Forecasting",      "Used for predictive modeling in solar energy systems."),
            ...
            ("starcoder2",               base_url_loc,   api_key_loc,   False,    "9.1 GB",   1,    True,  "transformer",  ["Next-gen Coding"],     "Cutting-edge Coding",     "Advanced model for next-generation code development."),
            ...
            ("wizard-math",              base_url_loc,   api_key_loc,   False,    "4.1 GB",   1,    False, "transformer",  ["Math Problems"],       "Mathematical Analysis",   "Specializes in solving complex mathematical problems."),
            ...
            ("xwinlm",                   base_url_loc,   api_key_loc,   False,    "3.8 GB",   1,    False, "transformer",  ["Cross-window Learning"],"Cross-learning",         "Facilitates learning across multiple data windows."),
